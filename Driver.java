...
public class Driver {
    ...
    public static void main(String[] args){
        ...
        double sum = 0;   //total proportions used by user
        int i = 0; //expense item index
        ...
        //do- while loop used to see when the condition is met
        do {
            System.out.print("Your proportion of expense " + (i + 1) + ":");
         ...
         for(double value: proportion){
            ...
            System.out.println("Your " + value + "% eqauls $" + expense);
         }
        }
}